...
void MainWindow::mouseMoveEvent(QMouseEvent* event) {
  ...
  while(rect.contains(x, y)) {
    ...
    // Если выходит за края, отодвигаем от краёв
    if(rect.top() < 0)
