...
void MainWindow::applyRegExp() {
  // Когда текст выражения меняется,
  // его надо заново применить
  // Когда текст для анализа меняется,
  // заново применяем регулярное выражение

  // Очищаем окно результатов
  ui->resultText->clear();

  // Создаём новое регулярное выражение на
  // основе строки
